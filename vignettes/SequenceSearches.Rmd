...
# Visualizing the output of `scan_sequences()`
...
## Skipping this will result in incorrect sequence sizes:
seqlengths(res) <- seqlengths(ArabidopsisPromoters)[names(seqlengths(res))]

autoplot(res, layout = "karyogram", aes(fill = motif)) +
  theme(
