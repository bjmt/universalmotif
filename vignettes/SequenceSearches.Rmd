...
## Discovering motifs with `motif_finder()`

`motif_finder()` is a yamtk-aligned _de novo_ motif discovery function.
...
of the input (matching yamtk's default) unless supplied via
`bkg.sequences`.
