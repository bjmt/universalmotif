...
Here we can see that the motif is significantly enriched in the target sequences. The `Pval` was calculated by calling `fisher.test` from the `r Rpackage("stats")` package.
