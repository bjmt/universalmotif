...
bkg <- match_bkg(target, universe, n.per.target = 2, rng.seed = 1)
...
composition bias relative to a genomic universe.
...
out   <- implant_motifs(ArabidopsisMotif, hosts, n.per.seq = 1, rng.seed = 1)
...
`return.indices = TRUE` and the same `rng.seed` to recover the
