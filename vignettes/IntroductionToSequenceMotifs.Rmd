...
go between these types can be seen in `?utilities`.
...
combinations of
letters such as these can be undesirable, as for example  mismatches can be quite
...
frequencies. For example, starting from the following background frequencies: 
