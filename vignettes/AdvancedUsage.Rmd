...
While `motif_tree()` works as a quick and convinient tree-building function, it can be inconvient when more control is required over tree construction. For this purpose, the following code goes through how exactly `motif_tree()` generates trees.
