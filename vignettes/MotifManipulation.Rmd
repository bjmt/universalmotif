...
motif comparison. These include `PWMSimlarity` (`Biocpkg("TFBSTools")`),
...
`Biocpkg("TFBSTools")` implementation as a source, the function has been
...
`Biocpkg("motifStack")`, and `r CRANpkg("ggseqlogo")`. Here I will briefly
