...
If you wish, it's easy to create random motifs. The values within the motif are generated using `rdirichlet()` (from `r CRANpkg("gtools")`) to avoid creating low information content motifs.
