...
create_tffm <- function(sequences, memefile, type = "first", ID = "Unknown",
  ...
  if (type == "first") {
    ...
    .create_first(first.letters, pc1, pc4, mot.len, motif.pfm, num.hits,
                  num.residues, name, ID, family, bkg) 

  } else if (type == "detailed") {

    warning("type 'detailed' currently does not work as intended")

    .create_detailed(first.letters, pc1, pc4, mot.len, motif.pfm, num.hits,
                     num.residues, name, ID, family, bkg) 
...
.create_first <- function(first.letters, pc1, pc4, mot.len, motif.pfm, num.hits,
                          num.residues, name, ID, family, bkg) {
...
.create_detailed <- function(first.letters, pc1, pc4, mot.len, motif.pfm,
                             num.hits, num.residues, name, ID, family, bkg) {
